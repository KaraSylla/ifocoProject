...
((window)=>{
  ...
  $(document).ready(() => {
    ...
    var msgErr = $('.alert.alert-danger');
    var messageSucces = $('.alert.alert-success');
  ...
  //       window.document.location.href = 'http://localhost:5000/formulaire-connexion';
  //     }, 4000);
  //   });
  //
  });
